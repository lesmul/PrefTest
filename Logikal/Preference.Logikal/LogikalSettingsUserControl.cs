...
public class LogikalSettingsUserControl : UserControl, IComponentConnector
{
	...
	public LogikalSettingsUserControl()
	{
		InitializeComponent();
	}
	...
	private void UserControl_Loaded(object sender, RoutedEventArgs e)
	{
		...
		{
			MessageBox.Show(PrefException.GetFormattedMessage("Error loading LogiKal settings.", ex), "", MessageBoxButton.OK, MessageBoxImage.Hand);
		}
	}
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri resourceLocator = new Uri("/Preference.Logikal;component/logikalsettingsusercontrol.xaml", UriKind.Relative);
	...
	void IComponentConnector.Connect(int connectionId, object target)
	{
		...
		{
		case 1:
			((LogikalSettingsUserControl)target).Loaded += UserControl_Loaded;
			break;
		case 2:
